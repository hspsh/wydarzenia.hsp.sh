...
![](/images/ikm-otwarty.png)

### Aktauliazcja

Jeśli jesteś zapisany/zapisana, sprawdź swoją skrzynkę email - wszelkie informacje o warsztatch są wysyłąne bezpośrednio na skrzynki email uczestników. Jeśli nie doszedł do Ciebie żaden email, proszę [napisz do mnie](mailto:mroz@pomorze.hackerspace.pl).


### Własny inteligentny dom 
...
[Przejdź do strony z zapisami na warsztaty.](https://nc.hsp.sh/index.php/apps/forms/S62wD9fPjgbqp9Fa)

Jeżeli zapisałeś się /zapisałaś się na warsztaty, ale nie możesz przyjść, proszę [wypisz się z warsztatów.](https://nc.hsp.sh/index.php/apps/forms/bPDBxKm78aibicW5)
